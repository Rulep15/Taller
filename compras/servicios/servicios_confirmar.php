...
if (isset($_REQUEST['vidservicio'])) {
    $gru = $_REQUEST['vidservicio'];
} else {
    echo 'VALORES VACIOS';
}
?>
...
<div class="panel-body">
    ...
    <form action = "servicios_control.php" method = "post" accept-charset = "utf-8" class = "form-horizontal">
            ...
            <h4 class = "modal-title" style="text-align: center"><strong>¿Desea confirmar el Presupuesot?</strong></h4>
            <input name="operacion" value="3" type="hidden">
            <input class="form-control" name="vidservicio" type="hidden" value="<?php echo $gru ?>"  readonly="" id="codigo" onkeypress="return soloNum(event)" required="">  
