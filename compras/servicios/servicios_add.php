                                ...
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            <?php $pc = consultas::get_datos("SELECT COALESCE(MAX(id_servicio),0)+1 AS ultimo FROM servicios") ?>
                                            <div class="col-lg-6 col-sm-6 col-xs-7">
                                                <input class="form-control" type="hidden" name="vidservicio" readonly="" value="<?php echo $pc[0]['ultimo']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6 col-sm-6 col-xs-7">
                                                <input class="form-control" type="text" name="vdescri" required="" autofocus>
                                            </div>
                                        </div>
