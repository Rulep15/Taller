                        ...
                        <div class="box box-primary">
                            <div class="box-header">
                                ...
                                <form action="nota_remision_control.php" method="POST" accept-charset="UTF-8" class="form-horizontal">
                                    <div class="box-body">
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4 col-sm-4 col-xs-4">
                                                    <?php $marcas = consultas::get_datos("SELECT * FROM orden_de_compra WHERE orden_estado = 'CONFIRMADO' OR orden_estado = 'EN PROCESO' ORDER BY nro_orden"); ?>
                                                    <select required="" class="form-control" id="factura" name="vorden" onchange="tiposelect();obtenercomp();" onclick="obtenercomp();">
                                    ...
                                    <div id="guardar" class="box-footer" style="text-align: right;">
