            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-xs-12">
                        ...
                        <?php } ?>
                        <!-- MENSAJE -->
                        <h3 style="color: white">Nota Remision - Detalle</h3>
                        <!--CABECERA-->
                                                        ...
                                                        <div class="col-lg-4 col-sm-4 col-md-4 col-xs-4">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
                                                                    <?php $productos = consultas::get_datos("SELECT * FROM ref_deposito WHERE id_depo = 2") ?>
                                                                    <select class="select2" name="vdeposito" required="" style="width: 300px;" id="idproducto" onchange="obtenerprecio()" onkeyup="obtenerprecio()" onclick="obtenerprecio()">
