                                ...
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <div>
                                            ...
                                            <input class="form-control" type="hidden" name="vidpresupuesto" value="<?php echo $pc[0]['ultimo']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label  col-lg-3 col-sm-2 col-xs-2">Pedido</label>
                                            <div class="col-lg-4 col-sm-4 col-xs-4">
                                                <?php $marcas = consultas::get_datos("SELECT * FROM pedido WHERE id_pedido !=0 ORDER BY id_pedido"); ?>
                                                <select class="form-control" id="factura" name="vidpedido" required="" onchange="tiposelect();obtenercomp();" onclick="obtenercomp();">
                                                    ...
                                                    if (!empty($marcas)) {
                                                        foreach ($marcas as $m) {
                                                    ?>
                                                            <option value="<?php echo $m['id_pedido']; ?>"><?php echo $m['id_pedido']; ?><?php echo '-'; ?><?php echo $m['fecha']; ?></option>
                                                        <?php
                                                        }
                                                    } else {
                                                        ?>
