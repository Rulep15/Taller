...
<div class="panel-body">
    ...
    <form action = "presupuesto_control.php" method = "post" accept-charset = "utf-8" class = "form-horizontal">
            ...
            <h4 class = "modal-title" style="text-align: center"><strong>¿Desea Anular el Presupuesto?</strong></h4>
            <input name="voperacion" value="3" type="hidden">
            <input class="form-control" name="vidpresupuesto" type="hidden" value="<?php echo $gru ?>"  readonly="" id="codigoanular" onkeypress="return soloNum(event)" required="">  
