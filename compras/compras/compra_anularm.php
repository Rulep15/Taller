...
<div class="panel-body">
    <div class="panel-body se">
        <form action="compras_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
            ...
            <h4 class="modal-title" style="text-align: center"><strong>¿Desea Anular la Compra?</strong></h4>
            <input name="voperacion" value="2" type="hidden">
            <input class="form-control" name="vidcompra" type="hidden" value="<?php echo $gru ?>" readonly="" id="codigoanular" onkeypress="return soloNum(event)" required="">
