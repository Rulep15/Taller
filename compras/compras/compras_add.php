                                ...
                                <form action="compras_control.php" method="POST" accept-charset="UTF-8" class="form-horizontal">
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <!--CHECKBOX DE ORDEN-->
                                            <!--CHECKBOX DE PEDIDO-->
                                            <div id="onepedi" style="display: none;" class="form-group">
                                                <label class="control-label  col-lg-3 col-sm-1 col-xs-3"></label>
                                                <div class="col-lg-1 col-sm-1 col-xs-1">
                                                    <label id="twopedi">
                                                        <input type="checkbox"  onchange="tiposelect()" onclick="tiposelect(); obtenerpedido()" name="pedido" value="pedido" id="pedi" />Pedido
                                                    </label>
                                                </div>
                                            </div>
                                            <!--CHECKBOX DE PEDIDO-->
    ...
    <script>
        function ocultar() {
            if (document.getElementById('orden').checked) {
                ...
                divtwo1 = document.getElementById('twopedi');
                divtwo1.style.display = '';
    ...
    <script>
        function ocultarcheck() {
            if (document.getElementById('idprov').value > 0) {
                ...
                divbox.style.display = '';
                divbox1 = document.getElementById('onepedi')
                divbox1.style.display = '';
            } else {
                divbox = document.getElementById('one')
                divbox.style.display = 'none';
