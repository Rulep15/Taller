...
$pdf->Cell(85, 1, 'T.A Taller Automotriz S.A', 0, 0, 'C', null, null, 1);
...
$pdf->Cell(95, 1, 'Dirección: Avda Saveedra c/Mcal. Estigarribia', 0, 0, 'L');
$pdf->Cell(75, 1, 'Factura de Compra', 0, 0, 'C');
$pdf->Ln(5);
$pdf->Cell(85, 1, 'Teléfono: 0991 487 147', 0, 0, 'C');
$pdf->SetFont('Times', 'B', 10);
...
$pdf->SetFont('Times', '', 10);
$pdf->Cell(2, 1, $rscompras[0]['com_ntimbrado'], 0, 0, 'L');
$pdf->Cell(29, 1, '   ' . '', 0, 0, 'C');
...
$pdf->Cell(/*1*/90, /*2*/ 1, /*3*/ $rscompras[0]['fecha_compra'], /*4*/ 0, /*5*/ 1, /*6*/ 'L', /*7*/ null, /*8*/ null, /*9*/ 1, /*10*/ null, /*11*/ null, /*12*/ null);
$pdf->Ln(3);
