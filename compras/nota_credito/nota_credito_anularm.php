...
<div class="panel-body">
    <div class="panel-body se">
        <form action="nota_credito_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
            <h4 class="modal-title" style="text-align: center"><strong>¿Desea Anular la Nota de Credito?</strong></h4>
            <input name="operacion" value="3" type="hidden">
            <input class="form-control" name="vcredito" type="hidden" value="<?php echo $gru ?>" readonly="" id="codigoanular" onkeypress="return soloNum(event)" required="">
