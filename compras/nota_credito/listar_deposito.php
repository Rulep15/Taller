...
<?php if (!empty($productos)) { ?>
    ...
    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
        <input type="text" required="" readonly placeholder="Deposito" class="form-control" name="vdeposito" value="<?php echo $productos[0]['dep_descri'] ?>" id="iddeposito" style="width: 300px;">
    </div>
<?php } else { ?>
