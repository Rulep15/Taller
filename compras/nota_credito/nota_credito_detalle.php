            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-xs-12">
                        ...
                        <?php } ?>
                        <!-- MENSAJE -->
                        <h3 style="color: white; text-align: center;">Nota Credito-Detalle</h3>
                        <!--CABECERA-->
                            ...
                            <div class="box-body no-padding">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-xs-12">
                                        ...
                                        $total = consultas::get_datos("SELECT sum(cantidad*precio) as total FROM detalle_credito where cod_notc=$idpedido");
                                        if ($total !== false && isset($total[0]['total'])) {
                                            $resultado = $total[0]['total'];
                                        } else {
                                            $resultado = 0;
                                        }
                                        $ivatotal = consultas::get_datos("SELECT sum(iva5+iva10+exentas) as totaliva FROM detalle_credito where cod_notc=$idpedido");
                                                    ...
                                                    <?php foreach ($pedidoscdetalle as $pcd) { ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <?php if ($pc['estado'] == 'ACTIVO') { ?>
                                                                    <a onclick="quitar(<?php echo "'" . $pcd['cod_notc'] . "_"   . $pcd['pro_cod'] . "'" ?>)" class="btn btn-toolbar " role="button" data-title="Eliminar Detalle" data-placement="top" rel="tooltip" data-toggle="modal" data-target="#quitar">
