...
<div class="panel-body">
    ...
    <form action = "pedidosc_control.php" method = "post" accept-charset = "utf-8" class = "form-horizontal">
            ...
            <h4 class = "modal-title" style="text-align: center"><strong>¿Desea Anular el Pedido?</strong></h4>
            <input name="voperacion" value="4" type="hidden">
            <input class="form-control" name="vidpedido" type="hidden" value="<?php echo $gru ?>"  readonly="" id="codigoanular" onkeypress="return soloNum(event)" required="">  
