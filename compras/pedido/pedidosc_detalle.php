    ...
    < <div class="modal fade" id="registrar_tipo" role="dialog" style="z-index: 1060;">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="tipo_producto_control.php" method="POST" accept-charset="UTF-8" class="form-horizontal">
                    <input name="voperacion" value="1" type="hidden">
                    <input name="vidtipo" value="0" type="hidden" id="vidtipo">
                    <input name="vidpedido" value="<?php echo $_REQUEST['vidpedido']; ?>" type="hidden" id="vidpedido">
                    <div class="box-body">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Descripcion</label>
                            <div class="col-xs-10 col-md-10 col-lg-10">
                                <input type="text" class="form-control" name="vdescripcionproducto" required="" autofocus="" id="vdescripcionproducto" onkeypress="return soloLetras(event);">
                            </div>
                        </div>
                    </div>
                    <div class="box-footer">
