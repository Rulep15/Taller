...
<SCRIPT>
    function obtener_pedido() {
        $.ajax({
            type: 'POST',
            url: "/Taller/informes/compras/pedidos/reporte_pedidos.php",
            cache: false,
            beforeSend: function() {
...
<SCRIPT>
    function obtener_compras() {
        $.ajax({
            type: 'POST',
            url: "/Taller/informes/compras/compras/reporte_compras.php",
            cache: false,
            beforeSend: function() {
                $('#cargando').html('<img src="/Taller/img/sistema/ajax-loader.gif"><strong><i>Cargando...</i></strong>');
            },
...
<SCRIPT>
    function obtener_orden() {
        $.ajax({
            type: 'POST',
            url: "/Taller/informes/compras/orden/reporte_orden.php",
            cache: false,
            beforeSend: function() {
                $('#cargando').html('<img src="/Taller/img/sistema/ajax-loader.gif"><strong><i>Cargando...</i></strong>');
            },
...
<SCRIPT>
    function obtener_presupuesto() {
        $.ajax({
            type: 'POST',
            url: "/Taller/informes/compras/presupuesto/reporte_presupuesto.php",
            cache: false,
            beforeSend: function() {
                $('#cargando').html('<img src="/Taller/img/sistema/ajax-loader.gif"><strong><i>Cargando...</i></strong>');
            },
...
<SCRIPT>
    function obtener_cuentas() {
        $.ajax({
            type: 'POST',
            url: "/Taller/informes/compras/cuenta/reporte_cuentas.php",
            cache: false,
            beforeSend: function() {
                $('#cargando').html('<img src="/Taller/img/sistema/ajax-loader.gif"><strong><i>Cargando...</i></strong>');
            },
...
<SCRIPT>
    function obtener_notacredito() {
        $.ajax({
            type: 'POST',
            url: "/Taller/informes/compras/notacredito/reporte_notacredito.php",
            cache: false,
            beforeSend: function() {
                $('#cargando').html('<img src="/Taller/img/sistema/ajax-loader.gif"><strong><i>Cargando...</i></strong>');
            },
...
<SCRIPT>
    function obtener_notaremision() {
        $.ajax({
            type: 'POST',
            url: "/Taller/informes/compras/notaremision/reporte_notaremision.php",
            cache: false,
            beforeSend: function() {
                $('#cargando').html('<img src="/Taller/img/sistema/ajax-loader.gif"><strong><i>Cargando...</i></strong>');
            },
...
<SCRIPT>
    function obtener_debito() {
        $.ajax({
            type: 'POST',
            url: "/Taller/informes/compras/notadebito/reporte_notadebito.php",
            cache: false,
            beforeSend: function() {
                $('#cargando').html('<img src="/Taller/img/sistema/ajax-loader.gif"><strong><i>Cargando...</i></strong>');
            },
...
<SCRIPT>
    function obtener_libro() {
        $.ajax({
            type: 'POST',
            url: "/Taller/informes/compras/libro/reporte_libro.php",
            cache: false,
            beforeSend: function() {
                $('#cargando').html('<img src="/Taller/img/sistema/ajax-loader.gif"><strong><i>Cargando...</i></strong>');
            },
