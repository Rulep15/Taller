                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12">
                        ...
                        <div class="box box-primary">
                            <div class="box-header">
                                ...
                                <div class="box-tools">
                                    <a class="btn btn-toolbar pull-right" role="button" data-toggle="modal" data-target="#registrar_cargo">
                                        <i style="color: #465F62" class="fa fa-plus"></i>
                                    </a>
                                    <a href="cargos_print.php" class="btn btn-toolbar pull-right" target="_blank">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-lg-12 col-md-12 col-xs-12">
                                                        <div class="input-group custom-search-form">
                                                            <input type="search" class="form-control" name="buscar" placeholder="Buscar por codigo o cargo..." autofocus="" />
                                                        ...
                                                        <?php foreach ($cargos as $cargo) { ?>
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    <a onclick="editar(<?php echo "'" . $cargo['id_cargo'] . "_" . $cargo['car_descri'] . "'"; ?>)" class="btn btn-sm btn-toolbar" role="button" data-title="Editar" data-placement="top" rel="tooltip" data-toggle="modal" data-target="#editar">
                                                                        <span style="color: #FFB400" class="glyphicon glyphicon-pencil"></span>
                                                                    </a>
                                                                    <a onclick="borrar(<?php echo "'" . $cargo['id_cargo'] . "_" . $cargo['car_descri'] . "'"; ?>)" class="btn  btn-toolbar" role="button" data-title="Borrar" data-placement="top" rel="tooltip" data-toggle="modal" data-target="#borrar">
                    ...
                    <form action="cargos_control.php" method="POST" accept-charset="UTF-8" class="form-horizontal">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Cargo</label>
                                <div class="col-xs-10 col-md-10 col-lg-10">
                                    <input type="text" class="form-control" name="vcardescri" required="" id="descripcion" onkeypress="return soloLetras(event);">
                                </div>
                            </div>
                        </div>
                        <div class="box-footer">
