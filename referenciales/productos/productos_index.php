                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12">
                        ...
                        <div class="box box-primary">
                            <div class="box-header">
                                ...
                                <!-- <div class="box-tools">
                                    <a href="productos_add.php" class="btn btn-toolbar pull-right">
                                        <i style="color: #465F62" class="fa fa-plus"></i>
                                    </a>
                                    <a href="productos_print.php" class="btn btn-toolbar  pull-right" target="_blank">
                            ...
                            <div class="box-body no-padding">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-xs-12">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-lg-12 col-md-12 col-xs-12">
                                                        <div class="input-group custom-search-form">
                                                            <input type="search" class="form-control" name="buscar" placeholder="Buscar por nombre de producto o por marca..." autofocus="" />
                                        ...
                                        $productos = consultas::get_datos("SELECT * FROM v_ref_producto WHERE pro_cod > 0 AND (pro_cod||TRIM(UPPER(mar_descri))) LIKE TRIM(UPPER('%" . $valor . "%')) ORDER BY pro_cod");
                                        if (!empty($productos)) {
                                        ?>
                                                        ...
                                                        <?php foreach ($productos as $p) { ?>
                                                            <tr>
                                                                ...
                                                                <!-- <td class="text-center">
                                                                    <a href="productos_edit.php?vidproducto=<?php echo $p['pro_cod']; ?>" class="btn btn-toolbar" role="button" data-title="Editar" rel="tooltip" data-placement="top">
                                                                        <span style="color: #FFB400" class="glyphicon glyphicon-edit"></span>
                                                                    </a>
                                                                    <a href="productos_delete.php?vidproducto=<?php echo $p['pro_cod']; ?>" class="btn btn-toolbar" role="button" data-title="Borrar" rel="tooltip" data-placement="top">
