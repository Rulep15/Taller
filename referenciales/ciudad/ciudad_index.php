                        ...
                        <div class="col-lg-12 col-md-12 col-xs-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <div class="box-tools">
                                        <!--AGREGAR-->
                                        <a href="ciudad_add.php" class="btn btn-toolbar pull-right ">
                                            <i style="color: #465F62" class="fa fa-plus"></i>
                                        </a>
                                        <!--IMPRIMIR-->
                                        <a href="ciudad_print.php" target="_blank" class="btn btn-toolbar  pull-right">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center">
                                                                        <a href="ciudad_edit.php?vidciudad=<?php echo $c['id_ciudad']; ?>" 
                                                                           class="btn btn-toolbar btn-md" role="button"
