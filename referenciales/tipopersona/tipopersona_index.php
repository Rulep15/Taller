                        ...
                        <div class="col-lg-12 col-md-12 col-xs-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <div class="box-tools">
                                        <a class="btn btn-toolbar pull-right" role="button"
                                           data-toggle="modal" data-target="#registrar">
                                            <i style="color: #465F62" class="fa fa-plus"></i>
                                        </a>
                                        <a href="tipopersona_print.php" class="btn btn-toolbar  pull-right" target="_blank">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center">
                                                                        <a onclick="editar(<?php echo "'" . $tipoimp['id_tipper'] . "_" . $tipoimp['tp_descri'] . "'"; ?>)" 
                                                                           class="btn btn-toolbar" role="button" data-title="Editar" 
                                                                        ...
                                                                        <a onclick="borrar(<?php echo "'" . $tipoimp['id_tipper'] . "_" . $tipoimp['tp_descri'] . "'"; ?>)" 
                                                                           class="btn  btn-toolbar" role="button" data-title="Borrar" 
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="tipopersona_control.php" method="POST" accept-charset="UTF-8" class="form-horizontal">
                            ...
                            <input name="vidtipoper" id="vidtipoper" value="0" type="hidden">
                            <div class="box-body">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Tipo</label>
                                    <div class="col-xs-10 col-md-10 col-lg-10">
                                        <input maxlength="30" type="text" class="form-control" id="vtipopdescri" name="vtipopdescri" required="" autofocus="" onkeypress="return soloLetras(event);">
                                    </div>
                                </div>
                            </div>
