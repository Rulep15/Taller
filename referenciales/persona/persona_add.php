...
<HTML>
                        ...
                        <div class="col-lg-12 col-md-12 col-xs-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <div class="box-tools">
                                        <a href="persona_index.php" class="btn btn-toolbar pull-right">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-6 col-sm-6 col-xs-6">
                                                    <div class="input-group">
                                                        ...
                                                        <span class="input-group-btn">
                                                            <button class="btn btn-toolbar btn-flat" type="button" data-toggle="modal" data-target="#registrar_tipopersona">
                                                                <i style="color: #465F62" class="fa fa-plus"></i>
                                                            </button>
                                                        </span>
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-6 col-sm-6 col-xs-7">
                                                    <input class="form-control" type="text" name="vruc" required="" style="width: 500px;" 
                                                           autofocus="" placeholder=" FORMATO: 0000000-0" pattern="[0-9]{7}-[0-9]{1}" title="Debe coincidir con el formato xxxxxxx-x" onkeypress="return soloNumero(event)">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-6 col-sm-6 col-xs-7">
                                                    <input class="form-control" type="number" name="vtelefono" required="" style="width: 500px;" 
                                                           autofocus="" maxlength="30" onkeypress="return soloNumero(event)">
                                                </div>
                                            </div>
                                            <div class="form-group">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form action="persona_control.php" method="POST" accept-charset="UTF-8" class="form-horizontal">
                                ...
                                <input name="vidciudad" id="vidciudad" value="0" type="hidden">
                                <div class="box-body">
                                    <!--PAIS-->
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-10 col-md-10 col-lg-10">
                                            <input type="text" class="form-control"  id="vnombre" name="vnombre" required="" autofocus="autofocus" id="vdescriciu" maxlength="30" onkeypress="return soloLetras(event);">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form action="persona_control.php" method="POST" accept-charset="UTF-8" class="form-horizontal">
                                ...
                                <input name="tipopersona" id="tipopersona"value="0" type="hidden">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Descripcion</label>
                                        <div class="col-xs-10 col-md-10 col-lg-10">
    ...
    <script>
        ...
        $("#cerrar_ciudad").click(function () {
            $('#vidciudad, #vnombre').val("");
        });
    </script>
    <SCRIPT>
        /*Focus para el primer input*/
        $(document).ready(function () {
            $('#registrar_tipopersona').on('show.bs.modal', function () {
                $('#vdescripcion').focus();
            });
        });
    </SCRIPT>  
    <script>
        /*limpiar campos al cerrar nuestro modal*/
        $("#cerrar_tipoper").click(function () {
            $('#tipopersona, #vdescripcion').val("");
        });
    </script>
